...
HD_PWD='C:/Users/Vlad/Desktop/Rom_luts/Rom_luts.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_block.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_block.tcl
